...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'rush_app_userprofile', u'id')


        # Changing field 'UserProfile.user'
        db.alter_column(u'rush_app_userprofile', 'user_id', self.gf('annoying.fields.AutoOneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))
        # Deleting field 'Reputation.id'
        db.delete_column(u'rush_app_reputation', u'id')


        # Changing field 'Reputation.rush'
        db.alter_column(u'rush_app_reputation', 'rush_id', self.gf('annoying.fields.AutoOneToOneField')(to=orm['rush_app.Rush'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Adding field 'UserProfile.id'
        db.add_column(u'rush_app_userprofile', u'id',
        ...
        # Adding field 'Reputation.id'
        db.add_column(u'rush_app_reputation', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)


        # Changing field 'Reputation.rush'
        db.alter_column(u'rush_app_reputation', 'rush_id', self.gf('annoying.fields.AutoOneToOneField')(to=orm['rush_app.Rush'], unique=True))
