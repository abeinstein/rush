...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rush.last_commented'
        db.alter_column(u'rush_app_rush', 'last_commented', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Rush.last_commented'
        raise RuntimeError("Cannot reverse this migration. 'Rush.last_commented' and its values cannot be restored.")
