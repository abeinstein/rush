...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rush.picture'
        db.alter_column(u'rush_app_rush', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Rush.picture'
        db.alter_column(u'rush_app_rush', 'picture', self.gf('django.db.models.fields.URLField')(max_length=200))
