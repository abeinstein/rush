...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Frat.password'
        db.add_column(u'rush_app_frat', 'password',
                      self.gf('django.db.models.fields.CharField')(default='password', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Frat.password'
        db.delete_column(u'rush_app_frat', 'password')
