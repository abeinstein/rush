...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Frat', fields ['chapter', 'name']
        db.delete_unique(u'rush_app_frat', ['chapter', 'name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Frat', fields ['chapter', 'name']
        db.create_unique(u'rush_app_frat', ['chapter', 'name'])
    ...
    models = {
        ...
        u'rush_app.frat': {
            ...
            'chapter': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
